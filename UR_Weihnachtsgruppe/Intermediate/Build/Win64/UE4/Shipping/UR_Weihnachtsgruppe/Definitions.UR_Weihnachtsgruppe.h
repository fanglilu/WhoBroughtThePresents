...
#define UE_PROJECT_NAME UR_Weihnachtsgruppe
#define UE_TARGET_NAME UR_Weihnachtsgruppe
#define UE_MODULE_NAME "UR_Weihnachtsgruppe"
...
#define CORE_API 
#define TRACELOG_API 
#define UR_WEIHNACHTSGRUPPE_API 
